...
Evaluate the CNN model (WSL) on the validation set, which contains the 3,000 images with clean labels.
...
```{r, eval=FALSE}
# Load images
imgs_test = array(NA, c(10000,32,32,3))
...
# Output to csv file
pred_results = data.frame(Index = 1:nrow(imgs_test),
