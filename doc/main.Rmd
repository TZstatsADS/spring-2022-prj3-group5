...
library(reticulate)
library(keras) # high-level neural networks API, written in Python and capable of running on top of TensorFlow, CNTK or Theano
library(tensorflow)
library(dplyr)
library(png)
library(glue)
...
clf = glm.fit(feature_mtx, target_vec)
```
